...
export default function ChatArea({ selectedModel, onModelChange }: ChatAreaProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-white via-blue-50/30 to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
      {/* Sticky Header */}
      <div className="flex items-center justify-between px-5 py-3 bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl border-b border-gray-200/40 dark:border-gray-800/40 shadow-sm sticky top-0 z-20">
